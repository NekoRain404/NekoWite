...
- 免安装可执行文件：`release/nekowite_0.1.0_x64.exe`（未签名），SHA-256：`4311eca5471ae4a036d5a8a3d352980cf944d4bd1860261b1b240c1fe4530577`（含保存前双面板冲刷、U+00A0 归一化、i18n 键补齐，以及 Windows 下后端测试全绿）。
