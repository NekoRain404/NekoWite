...
- 免安装可执行文件：`release/nekowite_0.1.0_x64.exe`（未签名），SHA-256：`9d561487c55a6c3715e3870b5748cb426b9dc952a2bbf50e2fbcfc4e4bc3e108`（含行内容器 MDX 静默截断修复与标题锚点 id 一致性修复；打包后按记录的 PID 启动 exe 冒烟验证：标题 `NekoWite`、`Responding=True`、工作集 29.3 MB，随后精确结束该进程）。
