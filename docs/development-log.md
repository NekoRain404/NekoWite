...
- 免安装可执行文件：`release/nekowite_0.1.0_x64.exe`（未签名），SHA-256：`a47f4e27d6eff1c89b21490798e1bd712bdd6a3905d057262541d1968a0483e3`（含图片首帧不再误报失败 + Retry 重新解析，以及 E2E 夹具可真实渲染图片）。
