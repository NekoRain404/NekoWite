...
- 免安装可执行文件：`release/nekowite_0.1.0_x64.exe`（未签名），SHA-256：`d6fc211ce23941bda74cf86baa342b65c0ad868691d0ef073f6c8e7c79a2d0f1`（含图片插入 / 工具栏 / 命令面板 / 插件按钮 / AI 选区的全量按视图模式路由，以及保存、导出与 AI 上下文的源码面板冲刷）。
