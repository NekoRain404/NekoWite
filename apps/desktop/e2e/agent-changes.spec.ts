...
const LABELS: AgentChangesLabels = {
  ...
  recovered: {
    recovered: 'The file is back at the version the request was made against',
    recoveredWarning: 'The version it replaced is not in the note\u2019s history',
    refused: {
      noBaseline: 'This host did not perform that write',
      baselineStale: 'The file moved since this host recorded it',
      unavailable: 'The file could not be read',
      changedSinceRecorded: 'The file is no longer what the agent left',
      alreadyAtBaseline: 'The file already holds the version to put back',
      writeRefused: 'The app\u2019s own save refused it',
    },
