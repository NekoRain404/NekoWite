      ...
      rows: [
        {
          ...
          result: '# probe\n\nwhat the call said it left',
          baseline: '# probe\n\nwhat the note held at the send',
          offers: ['view'],
          refused: { reason: 'unsaved-edits', path: 'notes/probe.md' },
          decision: null,
        },
      ],
      labels: {
        ...
        summary: '1 changed · 0 kept · 0 put back · 1 to review',
        ...
        diskUnread: 'No text for this file is recorded here',
      },
    },
  },
  {
