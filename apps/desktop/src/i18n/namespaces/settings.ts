    ...
    settings: {
      ...
      pet: {
        ...
        bubble: {
          ...
          themeLight: 'Light',
          themeDark: 'Dark',
          themeNote: 'The bubble on your desktop follows the app\'s theme, and the system\'s preference wherever the app is following it. Light and Dark override both.',
          fontSize: 'Text size',
    ...
    settings: {
      ...
      pet: {
        ...
        bubble: {
          ...
          themeLight: '浅色',
          themeDark: '深色',
          themeNote: '桌面上的气泡跟随应用主题；应用本身跟随系统时，它也跟随系统。浅色与深色可以覆盖两者。',
          fontSize: '文字大小',
          fontSizeOption: '{size}px',
