    ...
    settings: {
      ...
      pet: {
        ...
        character: {
          ...
          libraryUnavailable: 'Choosing, browsing or importing a character is not in this build: the character library and its importer have not landed, so the only action here is to clear the selection.',
    ...
    settings: {
      ...
      pet: {
        ...
        character: {
          ...
          selected: '已选：{id}',
          clear: '改为不使用角色',
          libraryUnavailable: '选择、浏览或导入角色不在本版本内：角色库与导入器尚未落地，所以这里能做的只有清除当前选择。',
          size: '画面大小 — {px} px',
