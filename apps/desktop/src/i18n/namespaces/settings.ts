    ...
    settings: {
      ...
      pet: {
        ...
        general: {
          ...
          enabledNote: 'Switching it off stops the drawing and the reminders. No agent task is cancelled, no note is lost, and no character, care progress or history is deleted.',
          motion: 'Motion',
          ...
          ballNote: 'The ball sits in a corner of the screen and stays where it is put. It is one of the pet’s windows, so it appears while the pet is on and goes away with it.',
          window: 'Window',
  ...
  zh: {
    settings: {
      ...
      pet: {
        ...
        general: {
          enabled: '显示桌宠',
          enabledNote: '关闭后停止绘制与提醒。不会取消任何 Agent 任务，不会丢失笔记，也不会删除角色、养成进度或历史记录。',
          motion: '动效',
          motionSystem: '跟随系统',
          motionReduced: '减少动效',
          motionNote: '桌宠可以比系统要求更保守，不能反过来解除限制。',
          ball: '显示悬浮球',
          ballNote: '悬浮球停在屏幕一角，放在哪里就停在哪里。它是桌宠的一个窗口，因此桌宠开启时它才出现，桌宠关闭时一起消失。',
          window: '窗口',
