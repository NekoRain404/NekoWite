...
import { planPaneSync, type PaneGeometry, type PaneSyncPlan } from '../controller/paneScrollMapping'
import { usePaneHandoff, type RenderedPaneHandoff } from './usePaneHandoff'
import type { SourcePaneExpose } from './useSourcePaneSlot'
