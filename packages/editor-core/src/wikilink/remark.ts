...
// literal `\[[a]]` arrives as value `[[a]]`. To tell it from a real wikilink
// we consult the source markdown and check whether the matching `[[` was
// backslash-escaped at its source offset (same technique as cite/remark.ts).
